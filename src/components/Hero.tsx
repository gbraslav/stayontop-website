      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-20 pt-16 sm:px-6 sm:pb-24 sm:pt-20 lg:px-8 lg:pb-32 lg:pt-24">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="flex flex-col justify-center">
            <p className="mb-4 text-sm font-semibold uppercase tracking-wider text-teal-600 dark:text-teal-400">
              For busy families and households
            </p>
            <h1 className="text-4xl font-bold leading-tight tracking-tight text-stone-900 sm:text-5xl lg:text-6xl dark:text-stone-50">
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center">
              <a
                href="#beta"
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-teal-600 px-6 py-3.5 text-base font-semibold text-white shadow-sm transition-all hover:bg-teal-700 hover:shadow-md"
              >
                Join the beta
              ...
              <a
                href="#how-it-works"
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-stone-300 bg-white px-6 py-3.5 text-base font-semibold text-stone-700 shadow-sm transition-all hover:bg-stone-50 hover:shadow-md dark:border-stone-600 dark:bg-stone-900 dark:text-stone-300 dark:hover:bg-stone-800"
              >
                See how it works
              ...
              <div className="overflow-hidden rounded-2xl border border-stone-200 bg-white shadow-lg dark:border-stone-700 dark:bg-stone-900">
                ...
                <div className="p-5">
                  ...
                  {[
                    ...
                    <div
                      key={item.label}
                      className="mb-3 flex items-center justify-between rounded-xl border border-stone-200 px-4 py-3 last:mb-0 dark:border-stone-700"
                    >
                      <div>
